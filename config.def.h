...
#else
static const char *fonts[]               = { "Mononoki Nerd Font Mono:size=9", "Noto Color Emoji:size=9:style=Regular" };
#endif // BAR_PANGO_PATCH
static const char dmenufont[]            = "Mononoki Nerd Font Mono:size=9";

static char c000000[]                    = "#000000"; // placeholder value

static char normfgcolor[]                = "#f5c2e7";
static char normbgcolor[]                = "#1e1e2e";
static char normbordercolor[]            = "#cba6f7";
static char normfloatcolor[]             = "#cba6f7";

static char selfgcolor[]                 = "#1e1e2e";
static char selbgcolor[]                 = "#f5c2e7";
static char selbordercolor[]             = "#f5c2e7";
static char selfloatcolor[]              = "#f5c2e7";

static char titlenormfgcolor[]           = "#f5c2e7";
...
static char titleselbgcolor[]            = "#f5c2e7";
static char titleselbordercolor[]        = "#f5c2e7";
static char titleselfloatcolor[]         = "#f5c2e7";
...
static char tagsselbgcolor[]             = "#f5c2e7";
static char tagsselbordercolor[]         = "#f5c2e7";
static char tagsselfloatcolor[]          = "#f5c2e7";

static char hidnormfgcolor[]             = "#1e1e2e";
static char hidselfgcolor[]              = "#1e1e2e";
static char hidnormbgcolor[]             = "#cba6f7";
static char hidselbgcolor[]              = "#cba6f7";

static char urgfgcolor[]                 = "#1e1e2e";
static char urgbgcolor[]                 = "#f9e2af";
static char urgbordercolor[]             = "#f9e2af";
static char urgfloatcolor[]              = "#f9e2af";
...
#endif // NAMETAG_PATCH
{
	[DEFAULT_TAGS]        = { "BRS", "MUS", "CHAT", "GAM", "IDE", "EDIT", "TERM", "FILE", "CONF"},
